...
| --------------- | ----------------------------- | --------------------------------------- |
| Bun             | `bun add @mkvlrn/result`      | `bunx jsr add @mkvlrn/result@0.3.5`     |
| npm             | `npm install @mkvlrn/result`  | `npx jsr add @mkvlrn/result@0.3.5`      |
| pnpm            | `pnpm add @mkvlrn/result`     | `pnpm dlx jsr add @mkvlrn/result@0.3.5` |
| Yarn            | `yarn add @mkvlrn/result`     | `yarn dlx jsr add @mkvlrn/result@0.3.5` |
| Deno            | `deno add npm:@mkvlrn/result` | `deno add jsr:@mkvlrn/result@0.3.5`     |
