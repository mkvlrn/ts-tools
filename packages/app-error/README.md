...
| --------------- | -------------------------------- | ------------------------------------------ |
| Bun             | `bun add @mkvlrn/app-error`      | `bunx jsr add @mkvlrn/app-error@0.4.5`     |
| npm             | `npm install @mkvlrn/app-error`  | `npx jsr add @mkvlrn/app-error@0.4.5`      |
| pnpm            | `pnpm add @mkvlrn/app-error`     | `pnpm dlx jsr add @mkvlrn/app-error@0.4.5` |
| Yarn            | `yarn add @mkvlrn/app-error`     | `yarn dlx jsr add @mkvlrn/app-error@0.4.5` |
| Deno            | `deno add npm:@mkvlrn/app-error` | `deno add jsr:@mkvlrn/app-error@0.4.5`     |
