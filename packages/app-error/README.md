...
```bash
bunx jsr add @mkvlrn/app-error@0.3.1 # bun
pnpm dlx jsr add @mkvlrn/app-error@0.3.1 # pnpm
yarn dlx jsr add @mkvlrn/app-error@0.3.1 # yarn
deno add jsr:@mkvlrn/app-error@0.3.1 # deno
npx jsr add @mkvlrn/app-error@0.3.1 # npm
```
