...
```bash
bunx jsr add -D @mkvlrn/config@0.3.1 # bun
pnpm dlx jsr add @mkvlrn/config@0.3.1 # pnpm
yarn dlx jsr add @mkvlrn/config@0.3.1 # yarn
deno add -D jsr:@mkvlrn/config@0.3.1 # deno
npx jsr add -D @mkvlrn/config@0.3.1 # npm
```
