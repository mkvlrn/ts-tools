...
```bash
bunx jsr add -D @mkvlrn/config@0.4.2 # bun
pnpm dlx jsr add @mkvlrn/config@0.4.2 # pnpm
yarn dlx jsr add @mkvlrn/config@0.4.2 # yarn
deno add -D jsr:@mkvlrn/config@0.4.2 # deno
npx jsr add -D @mkvlrn/config@0.4.2 # npm
```
