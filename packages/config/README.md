...
| --------------- | -------------------------------- | ------------------------------------------ |
| Bun             | `bun add @mkvlrn/config -D`      | `bunx jsr add @mkvlrn/config@0.4.7 -D`     |
| npm             | `npm install @mkvlrn/config -D`  | `npx jsr add @mkvlrn/config@0.4.7 -D`      |
| pnpm            | `pnpm add @mkvlrn/config -D`     | `pnpm dlx jsr add @mkvlrn/config@0.4.7 -D` |
| Yarn            | `yarn add @mkvlrn/config -D`     | `yarn dlx jsr add @mkvlrn/config@0.4.7 -D` |
| Deno            | `deno add npm:@mkvlrn/config -D` | `deno add jsr:@mkvlrn/config@0.4.7 -D`     |
